...
/**
 * Servlet implementation class ProductSearchFinder
 */
@WebServlet("/product/productIOFinder")
public class ProductIOSearchFinder extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			// 2. 업무로직
			List<ProductIOExt> productsIOExtList = productService.findBySomething(searchParam);
			
			int findContents = productService.getSearchProductsIOContent(searchParam);
