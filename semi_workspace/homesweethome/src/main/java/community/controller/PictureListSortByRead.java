...
/**
 * Servlet implementation class PictureListSortByRead
 */
@WebServlet("/community/picture/sortByRead")
public class PictureListSortByRead extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) 
		...
		try {
			...
			List<PictureExt> list = ps.sortRead(param);
