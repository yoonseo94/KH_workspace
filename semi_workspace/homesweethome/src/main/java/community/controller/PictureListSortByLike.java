...
/**
 * Servlet implementation class PictureListSortByLike
 */
@WebServlet("/community/picture/sortByLike")
public class PictureListSortByLike extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			List<PictureExt> list = ps.sortLike(param);
