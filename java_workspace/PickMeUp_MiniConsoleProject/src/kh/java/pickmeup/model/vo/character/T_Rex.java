...
public class T_Rex extends Character implements Attackable, DailyRoutinable, Serializable {
	...
	public void levelUp() {
			...
			if(this.level == 5) {
				System.out.println("축하합니다. 5레벨이 되어서 특수공격 [꼬리치기]을 습득하였습니다.");
			}
			if(this.level == 10) {
				System.out.println("축하합니다. 10레벨이 되어서 특수공격 [물어뜯기]을 습득하였습니다.");
			}
			if(this.level == 15) {
				System.out.println("축하합니다. 15레벨이 되어서 특수공격 [즉살]를 습득하였습니다.");
			}
	}
	...
	public void normalAttack(Monster monster) {
		int plusDamage = 0;
		System.out.printf("%s이/가 살기 공격을 합니다.%n", this.nickName);
	...
	public void specialAttack1(Monster monster) {
		...
		int plusDamage = (int)(30 + (1.5 * this.level));
		System.out.printf("%s이/가 특수공격 [포효]을 사용합니다.%n", this.nickName);
	...
	public void specialAttack2(Monster monster) {
		if(this.level >= 5) {
			...
			int plusDamage = (60 + (2 * this.level));
			System.out.printf("%s이/가 특수공격 [꼬리치기]을 사용합니다.%n", this.nickName);
	...
	public void specialAttack3(Monster monster) {
		if(this.level >= 10) {
			...
			int plusDamage = (120 + (3 * this.level));
			System.out.printf("%s이/가 특수공격 [물어뜯기]을 사용합니다.%n", this.nickName);
	...
	public void specialAttack4(Monster monster) {
		if(this.level >= 15) {
			...
			int plusDamage = (220 + (5 * this.level));
			System.out.printf("%s이/가 특수공격 [즉살]을 사용합니다.%n", this.nickName);
