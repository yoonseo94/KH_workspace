...
public class Haetae extends Character implements Attackable, DailyRoutinable, Serializable {

	private static final long serialVersionUID = 3L;
	
	public Haetae() {
		this.race = "LegendaryCreature";
		this.originNo = 3;
		this.name = "해태";
		this.nickName = "해태";
		this.level = 1;
	...
	public void levelUp() {
			...
			if(this.level == 5) {
				System.out.println("축하합니다. 5레벨이 되어서 특수공격 [화염 돌진]을 습득하였습니다.");
			}
			if(this.level == 10) {
				System.out.println("축하합니다. 10레벨이 되어서 특수공격 [화염탄]을 습득하였습니다.");
			}
			if(this.level == 15) {
				System.out.println("축하합니다. 15레벨이 되어서 특수공격 [태양 던지기]를 습득하였습니다.");
			}
	}
	...
	public void normalAttack(Monster monster) {
		int plusDamage = 0;
		System.out.printf("%s이/가 할퀴기 공격을 합니다.%n", this.nickName);
	...
	public void specialAttack1(Monster monster) {
		...
		System.out.printf("%s이/가 특수공격 [약점 공격]을 사용합니다.%n", this.nickName);
	...
	public void specialAttack2(Monster monster) {
		if(this.level >= 5) {
			...
			System.out.printf("%s이/가 특수공격 [화염 돌진]을 사용합니다.%n", this.nickName);
	...
	public void specialAttack3(Monster monster) {
		if(this.level >= 10) {
			...
			System.out.printf("%s이/가 특수공격 [화염탄]을 사용합니다.%n", this.nickName);
	...
	public void specialAttack4(Monster monster) {
		if(this.level >= 15) {
			...
			System.out.printf("%s이/가 특수공격 [태양 던지기]을 사용합니다.%n", this.nickName);
