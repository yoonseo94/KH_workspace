...
public class Baekho extends Character implements Attackable, DailyRoutinable, Serializable {
	...
	public void levelUp() {
			...
			if(this.level == 5) {
				System.out.println("축하합니다. 5레벨이 되어서 특수공격 [암석 던지기]를 습득하였습니다.");
			}
			if(this.level == 10) {
				System.out.println("축하합니다. 10레벨이 되어서 특수공격 [호왕조]를 습득하였습니다.");
			}
			if(this.level == 15) {
				System.out.println("축하합니다. 15레벨이 되어서 특수공격 [지진]을 습득하였습니다.");
			}
	}
	...
	public void normalAttack(Monster monster) {
		int plusDamage = 0;
		System.out.printf("%s이/가 물기 공격을 합니다.%n", this.nickName);
	...
	public void specialAttack1(Monster monster) {
		...
		System.out.printf("%s이/가 특수공격 [돌진]을 사용합니다.%n", this.nickName);
	...
	public void specialAttack2(Monster monster) {
		if(this.level >= 5) {
			...
			System.out.printf("%s이/가 특수공격 [암석 던지기]를 사용합니다.%n", this.nickName);
	...
	public void specialAttack3(Monster monster) {
		if(this.level >= 10) {
			...
			System.out.printf("%s이/가 특수공격 [호왕조]을 사용합니다.%n", this.nickName);
	...
	public void specialAttack4(Monster monster) {
		if(this.level >= 15) {
			...
			System.out.printf("%s이/가 특수공격 [지진]을 사용합니다.%n", this.nickName);
