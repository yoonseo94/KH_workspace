...
public class Jujak extends Character implements Attackable, DailyRoutinable, Serializable {
	...
	public void levelUp() {
			...
			if(this.level == 5) {
				System.out.println("축하합니다. 5레벨이 되어서 특수공격 [화염깃털 사출]을 습득하였습니다.");
			}
			if(this.level == 10) {
				System.out.println("축하합니다. 10레벨이 되어서 특수공격 [화염구]를 습득하였습니다.");
			}
			if(this.level == 15) {
				System.out.println("축하합니다. 15레벨이 되어서 특수공격 [화염폭풍]을 습득하였습니다.");
			}
	}
	...
	public void normalAttack(Monster monster) {
		int plusDamage = 0;
		System.out.printf("%s이/가 쪼기 공격을 합니다.%n", this.nickName);
	...
	public void specialAttack1(Monster monster) {
		...
		System.out.printf("%s이/가 특수공격 [날개 치기]를 사용합니다.%n", this.nickName);
	...
	public void specialAttack2(Monster monster) {
		if(this.level >= 5) {
			...
			System.out.printf("%s이/가 특수공격 [화염깃털 사출]을 사용합니다.%n", this.nickName);
	...
	public void specialAttack3(Monster monster) {
		if(this.level >= 10) {
			...
			System.out.printf("%s이/가 특수공격 [화염구]를 사용합니다.%n", this.nickName);
	...
	public void specialAttack4(Monster monster) {
		if(this.level >= 15) {
			...
			System.out.printf("%s이/가 특수공격 [화염폭풍]을 사용합니다.%n", this.nickName);
