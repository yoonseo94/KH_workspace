...
<jsp:include page="/WEB-INF/views/common/header.jsp">
	...
	<div id="menu-container" class="text-center">
        ...
        /**
         * Access to XMLHttpRequest at 'http://localhost:10000/springboot/menu/1' from origin 'http://localhost:9090' has been blocked by CORS policy: 
         ...
         *  - 동일근원정책
         *  - 웹브라우져에서 비동기요청을 보낼때(ajax) 반드시 같은 origin으로만 요청을 보낼수 있다. 
         *  - http://localhost:9090 -> http://localhost:10000 요청보낼수 없다.
         * 
         * CORS Policy
         *  - Cross Origin Resource Sharing Policy 
         *  - sop를 넘어서는 ajax요청을 위한 정책
         *  - Access-Control-Allow-Origin 헤더에 해당 orgin이 명시되어 있어야 한다.
         * 
         *
         * CORS처리
