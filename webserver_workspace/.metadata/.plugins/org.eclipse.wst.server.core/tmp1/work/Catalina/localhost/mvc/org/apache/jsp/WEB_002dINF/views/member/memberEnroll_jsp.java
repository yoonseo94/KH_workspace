 ...
 * Generated at: 2022-06-08 02:48:49 UTC
...
public final class memberEnroll_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(loginMember != null && loginMember.getMemberRole() == MemberRole.A) { 
      ...
      out.write("				<td>	\r\n");
      out.write("				<input type=\"date\" name=\"birthday\" id=\"birthday\" value=\"1979-07-07\" ><br />\r\n");
      out.write("				</td>\r\n");
      out.write("			</tr> \r\n");
      out.write("			<tr>\r\n");
      out.write("				<th>이메일</th>\r\n");
      ...
      out.write("				<td>	\r\n");
      out.write("					<input type=\"tel\" placeholder=\"(-없이)01012345678\" name=\"phone\" id=\"phone\" maxlength=\"11\" value=\"01044445555\" required><br>\r\n");
      out.write("				</td>\r\n");
      out.write("			</tr>\r\n");
      out.write("			<tr>\r\n");
      out.write("				<th>주소</th>\r\n");
      ...
      out.write("					<input type=\"radio\" name=\"gender\" id=\"gender1\" value=\"F\" checked>\r\n");
      ...
      out.write("					<input type=\"checkbox\" name=\"hobby\" id=\"hobby3\" value=\"게임\" checked><label for=\"hobby3\">게임</label>\r\n");
      ...
      out.write("	const title = \"checkIdDuplicatePopup\";\r\n");
      out.write("	const spec = \"width=300px, height=200px\";\r\n");
      out.write("	const popup = open(\"\", title, spec);\r\n");
      out.write("	\r\n");
      out.write("	const frm = document.checkIdDuplicateFrm;\r\n");
      out.write("	frm.target = title; // 해당팝업에서 폼을 제출!\r\n");
      out.write("	frm.memberId.value = _memberId.value;\r\n");
      out.write("	frm.submit();\r\n");
      out.write("};\r\n");
      out.write("\r\n");
      out.write("passwordCheck.onblur = () => {\r\n");
      out.write("	if(_password.value !== passwordCheck.value){\r\n");
      ...
      out.write("\r\n");
      out.write("/**\r\n");
      out.write(" * 회원가입폼 유효성 검사\r\n");
      out.write(" */\r\n");
      out.write("document.memberEnrollFrm.onsubmit = () => {\r\n");
      out.write("	// memberId 영문자/숫자 4글자 이상\r\n");
      out.write("	if(!/^[A-Za-z0-9]{4,}$/.test(_memberId.value)){\r\n");
      out.write("		alert(\"아이디는 영문자/숫자로 4글자 이상이어야 합니다.\");\r\n");
      out.write("		return false;\r\n");
      out.write("	}  \r\n");
      out.write("	// 중복검사여부 체크\r\n");
      out.write("	if(idValid.value !== \"1\") {\r\n");
      out.write("		alert(\"아이디 중복검사 해주세요.\");\r\n");
      out.write("		return false;\r\n");
      out.write("	}\r\n");
      out.write("	// password 영문자/숫자/특수문자!@#$%^&*()\r\n");
      out.write("	if(!/^[A-Za-z0-9!@#$%^&*()]{4,}$/.test(_password.value)){\r\n");
      out.write("		alert(\"비밀번호는 영문자/숫자/특수문자!@#$%^&*()로 4글자 이상이어야 합니다.\");\r\n");
      out.write("		return false;\r\n");
      out.write("	}\r\n");
      out.write("	if(!passwordCheck.onblur()){\r\n");
      out.write("		return false;		\r\n");
      out.write("	}\r\n");
      out.write("	\r\n");
